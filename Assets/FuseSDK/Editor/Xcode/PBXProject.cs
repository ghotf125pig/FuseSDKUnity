...
using System.IO;
using UnityEditorCompat.iOS.Xcode.PBX;
...
namespace UnityEditorCompat.iOS.Xcode
{
    ...
    public class PBXProject
    {
        ...
        public bool ContainsFramework(string targetGuid, string framework, string frameworkLocation = "System/Library/Frameworks/")
        {
            var fileGuid = FindFileGuidByRealPath(frameworkLocation + framework, PBXSourceTree.Sdk);
            if (fileGuid == null)
                return false;
        ...
        /// <param name="frameworkLocation">The location of the framework on the computer. Usually System/Library/Frameworks.</param>
        public void AddFrameworkToProject(string targetGuid, string framework, bool weak, string frameworkLocation = "System/Library/Frameworks/")
        {
            string fileGuid = AddFile(frameworkLocation + framework, "Frameworks/" + framework, PBXSourceTree.Sdk);
        ...
        /// <param name="framework">The name of the framework. The extension of the filename must be ".framework".</param>
        /// <param name="frameworkLocation">The location of the framework on the computer. Usually System/Library/Frameworks.</param>
        public void RemoveFrameworkFromProject(string targetGuid, string framework, string frameworkLocation = "System/Library/Frameworks/")
        {
            var fileGuid = FindFileGuidByRealPath(frameworkLocation + framework, PBXSourceTree.Sdk);
            if (fileGuid == null)
                return;
