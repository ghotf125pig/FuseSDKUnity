...
namespace UnityEditorCompat.iOS.Xcode
{
    ...
    public class PlistElement
    {
		...
		public string AsDateString() { return ((PlistElementDateString)this).value; }
		public int AsInteger()   { return ((PlistElementInteger)this).value; }
		public float AsFloat() { return ((PlistElementFloat)this).value; }
	...
	public class PlistElementDateString : PlistElement
	{
		public PlistElementDateString(string v) { value = v; }
    ...
    public class PlistElementDict : PlistElement
    {
		...
		{
			values[key] = new PlistElementFloat(val);
		}
		...
		public void SetDateString(string key, string val)
		{
			values[key] = new PlistElementDateString(val);
		}
    ...
    public class PlistElementArray : PlistElement
    {
		...
		public void AddDateString(string val)
		{
			values.Add(new PlistElementDateString(val));
		}
		...
		{
			values.Add(new PlistElementFloat(val));
		}
    ...
    public class PlistDocument
    {
        ...
        private static PlistElement ReadElement(XElement xml)
        {
            switch (xml.Name.LocalName)
            {
				...
				case "date":
					return new PlistElementDateString(GetText(xml));
				case "integer":
                {
                    int r;
